...
final /* synthetic */ class zzj implements Runnable {
    ...
    public final void run() {
        ...
        L_0x0002:
            monitor-enter(r0)
            int r1 = r0.zza     // Catch:{ all -> 0x00b3 }
            r2 = 2
            if (r1 == r2) goto L_0x000a
            monitor-exit(r0)     // Catch:{ all -> 0x00b3 }
            return
        L_0x000a:
            java.util.Queue<com.google.android.gms.cloudmessaging.zzq<?>> r1 = r0.zzd     // Catch:{ all -> 0x00b3 }
            boolean r1 = r1.isEmpty()     // Catch:{ all -> 0x00b3 }
            if (r1 == 0) goto L_0x0017
            r0.zzb()     // Catch:{ all -> 0x00b3 }
            monitor-exit(r0)     // Catch:{ all -> 0x00b3 }
            return
        L_0x0017:
            java.util.Queue<com.google.android.gms.cloudmessaging.zzq<?>> r1 = r0.zzd     // Catch:{ all -> 0x00b3 }
            java.lang.Object r1 = r1.poll()     // Catch:{ all -> 0x00b3 }
            com.google.android.gms.cloudmessaging.zzq r1 = (com.google.android.gms.cloudmessaging.zzq) r1     // Catch:{ all -> 0x00b3 }
            android.util.SparseArray<com.google.android.gms.cloudmessaging.zzq<?>> r3 = r0.zze     // Catch:{ all -> 0x00b3 }
            int r4 = r1.zza     // Catch:{ all -> 0x00b3 }
            r3.put(r4, r1)     // Catch:{ all -> 0x00b3 }
            com.google.android.gms.cloudmessaging.zze r3 = r0.zzf     // Catch:{ all -> 0x00b3 }
            java.util.concurrent.ScheduledExecutorService r3 = r3.zzc     // Catch:{ all -> 0x00b3 }
            com.google.android.gms.cloudmessaging.zzl r4 = new com.google.android.gms.cloudmessaging.zzl     // Catch:{ all -> 0x00b3 }
        ...
        L_0x0069:
            ...
            r4.putBundle(r3, r1)
            r5.setData(r4)
            com.google.android.gms.cloudmessaging.zzo r1 = r0.zzc     // Catch:{ RemoteException -> 0x00a9 }
            r1.zza(r5)     // Catch:{ RemoteException -> 0x00a9 }
            goto L_0x0002
        L_0x00a9:
            r1 = move-exception
