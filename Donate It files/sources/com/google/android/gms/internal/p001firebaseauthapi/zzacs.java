...
final class zzacs {
    private static final zzacp zza = new zzacq();

    static {
        if (zzacn.zza() && zzacn.zzb()) {
            int i = zzyl.zza;
        }
    }
    ...
    static String zze(byte[] bArr, int i, int i2) throws zzaai {
        int i3;
        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            while (r11 < i4) {
                ...
                if (zzaco.zza(b2)) {
                    ...
                    if (i6 < i4 - 1) {
                        int i7 = i6 + 1;
                        zzaco.zzc(b2, bArr[i6], bArr[i7], cArr, i3);
                        r11 = i7 + 1;
                        i3++;
                    } else {
                        throw zzaai.zzi();
                    ...
                    int i8 = i6 + 1;
                    int i9 = i8 + 1;
                    zzaco.zzd(b2, bArr[i6], bArr[i8], bArr[i9], cArr, i3);
                    i3 += 2;
                    r11 = i9 + 1;
                } else {
                    throw zzaai.zzi();
