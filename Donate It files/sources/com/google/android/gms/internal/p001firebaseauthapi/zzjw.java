...
public final class zzjw implements zzag {
    private static final ThreadLocal<Cipher> zza = new zzju();
    private static final ThreadLocal<Cipher> zzb = new zzjv();
    ...
    public zzjw(byte[] bArr, int i) throws GeneralSecurityException {
        if (i == 12 || i == 16) {
            this.zzf = i;
