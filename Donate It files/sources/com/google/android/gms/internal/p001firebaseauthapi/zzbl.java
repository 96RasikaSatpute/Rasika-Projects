...
public final class zzbl {
    ...
    public static synchronized <KeyProtoT extends zzabd> void zza(zzat<KeyProtoT> zzat, boolean z) throws GeneralSecurityException {
    ...
    public static synchronized <KeyProtoT extends zzabd, PublicKeyProtoT extends zzabd> void zzb(zzbg<KeyProtoT, PublicKeyProtoT> zzbg, zzat<PublicKeyProtoT> zzat, boolean z) throws GeneralSecurityException {
        Class<?> zze2;
        synchronized (zzbl.class) {
    ...
    public static synchronized zzabd zzf(zzih zzih) throws GeneralSecurityException {
        zzabd zzc2;
        synchronized (zzbl.class) {
    ...
    public static zzic zzg(String str, zzyy zzyy) throws GeneralSecurityException {
        zzan zzp = zzp(str, (Class) null);
        if (zzp instanceof zzbf) {
            return ((zzbf) zzp).zze(zzyy);
        }
    ...
    public static <P> P zzh(String str, zzabd zzabd, Class<P> cls) throws GeneralSecurityException {
        return zzp(str, cls).zzb(zzabd);
    }

    public static <P> P zzi(String str, byte[] bArr, Class<P> cls) throws GeneralSecurityException {
        return zzq(str, zzyy.zzm(bArr), cls);
    }
    ...
    public static <B, P> P zzl(com.google.android.gms.internal.p001firebaseauthapi.zzbd<B> r4, java.lang.Class<P> r5) throws java.security.GeneralSecurityException {
        /*
            java.util.concurrent.ConcurrentMap<java.lang.Class<?>, com.google.android.gms.internal.firebase-auth-api.zzbe<?, ?>> r0 = zzf
            java.lang.Object r5 = r0.get(r5)
            com.google.android.gms.internal.firebase-auth-api.zzbe r5 = (com.google.android.gms.internal.p001firebaseauthapi.zzbe) r5
        ...
        L_0x0041:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p001firebaseauthapi.zzbl.zzl(com.google.android.gms.internal.firebase-auth-api.zzbd, java.lang.Class):java.lang.Object");
    }
    ...
    private static synchronized void zzo(java.lang.String r6, java.lang.Class<?> r7, boolean r8) throws java.security.GeneralSecurityException {
        /*
            java.lang.Class<com.google.android.gms.internal.firebase-auth-api.zzbl> r0 = com.google.android.gms.internal.p001firebaseauthapi.zzbl.class
            monitor-enter(r0)
            java.util.concurrent.ConcurrentMap<java.lang.String, com.google.android.gms.internal.firebase-auth-api.zzbk> r1 = zzb     // Catch:{ all -> 0x008a }
            boolean r2 = r1.containsKey(r6)     // Catch:{ all -> 0x008a }
            if (r2 != 0) goto L_0x000d
            monitor-exit(r0)
            return
        L_0x000d:
            java.lang.Object r1 = r1.get(r6)     // Catch:{ all -> 0x008a }
            com.google.android.gms.internal.firebase-auth-api.zzbk r1 = (com.google.android.gms.internal.p001firebaseauthapi.zzbk) r1     // Catch:{ all -> 0x008a }
            java.lang.Class r2 = r1.zzc()     // Catch:{ all -> 0x008a }
            boolean r2 = r2.equals(r7)     // Catch:{ all -> 0x008a }
            if (r2 != 0) goto L_0x0060
            java.util.logging.Logger r8 = zza     // Catch:{ all -> 0x008a }
            java.util.logging.Level r2 = java.util.logging.Level.WARNING     // Catch:{ all -> 0x008a }
            java.lang.String r3 = "Attempted overwrite of a registered key manager for key type "
            int r4 = r6.length()     // Catch:{ all -> 0x008a }
            if (r4 == 0) goto L_0x002e
            java.lang.String r3 = r3.concat(r6)     // Catch:{ all -> 0x008a }
            goto L_0x0034
        L_0x002e:
            java.lang.String r4 = new java.lang.String     // Catch:{ all -> 0x008a }
        ...
        L_0x0034:
            ...
            r8.logp(r2, r4, r5, r3)     // Catch:{ all -> 0x008a }
            java.security.GeneralSecurityException r8 = new java.security.GeneralSecurityException     // Catch:{ all -> 0x008a }
            r2 = 3
            java.lang.Object[] r2 = new java.lang.Object[r2]     // Catch:{ all -> 0x008a }
            r3 = 0
            r2[r3] = r6     // Catch:{ all -> 0x008a }
            r6 = 1
            java.lang.Class r1 = r1.zzc()     // Catch:{ all -> 0x008a }
            java.lang.String r1 = r1.getName()     // Catch:{ all -> 0x008a }
            r2[r6] = r1     // Catch:{ all -> 0x008a }
            r6 = 2
            java.lang.String r7 = r7.getName()     // Catch:{ all -> 0x008a }
            r2[r6] = r7     // Catch:{ all -> 0x008a }
            java.lang.String r6 = "typeUrl (%s) is already registered with %s, cannot be re-registered with %s"
            java.lang.String r6 = java.lang.String.format(r6, r2)     // Catch:{ all -> 0x008a }
            r8.<init>(r6)     // Catch:{ all -> 0x008a }
            throw r8     // Catch:{ all -> 0x008a }
        L_0x0060:
            if (r8 == 0) goto L_0x0088
            java.util.concurrent.ConcurrentMap<java.lang.String, java.lang.Boolean> r7 = zzd     // Catch:{ all -> 0x008a }
            java.lang.Object r7 = r7.get(r6)     // Catch:{ all -> 0x008a }
            java.lang.Boolean r7 = (java.lang.Boolean) r7     // Catch:{ all -> 0x008a }
            boolean r7 = r7.booleanValue()     // Catch:{ all -> 0x008a }
            if (r7 != 0) goto L_0x0088
            java.security.GeneralSecurityException r7 = new java.security.GeneralSecurityException     // Catch:{ all -> 0x008a }
            java.lang.String r8 = "New keys are already disallowed for key type "
            int r1 = r6.length()     // Catch:{ all -> 0x008a }
            if (r1 == 0) goto L_0x007f
            java.lang.String r6 = r8.concat(r6)     // Catch:{ all -> 0x008a }
            goto L_0x0084
        L_0x007f:
            java.lang.String r6 = new java.lang.String     // Catch:{ all -> 0x008a }
            r6.<init>(r8)     // Catch:{ all -> 0x008a }
        L_0x0084:
            r7.<init>(r6)     // Catch:{ all -> 0x008a }
        ...
        L_0x008a:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p001firebaseauthapi.zzbl.zzo(java.lang.String, java.lang.Class, boolean):void");
    }
    ...
    private static <P> P zzq(String str, zzyy zzyy, Class<P> cls) throws GeneralSecurityException {
        return zzp(str, cls).zza(zzyy);
    }
}
