...
interface zzabo {
    ...
    <T> void zzG(List<T> list, zzabp<T> zzabp, zzzn zzzn) throws IOException;

    @Deprecated
    <T> void zzH(List<T> list, zzabp<T> zzabp, zzzn zzzn) throws IOException;

    void zzI(List<zzyy> list) throws IOException;
    ...
    <T> T zzo(zzabp<T> zzabp, zzzn zzzn) throws IOException;

    @Deprecated
    <T> T zzp(zzabp<T> zzabp, zzzn zzzn) throws IOException;

    zzyy zzq() throws IOException;
