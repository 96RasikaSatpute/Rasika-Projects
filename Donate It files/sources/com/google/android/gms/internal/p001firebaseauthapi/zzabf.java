...
final class zzabf {
    static String zza(zzabd zzabd, String str) {
    ...
    static final void zzb(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"");
                sb.append(zzacb.zza(zzyy.zzo((String) obj)));
                sb.append(Typography.quote);
            } else if (obj instanceof zzyy) {
                sb.append(": \"");
                sb.append(zzacb.zza((zzyy) obj));
                sb.append(Typography.quote);
            } else if (obj instanceof zzaaa) {
                sb.append(" {");
                zzc((zzaaa) obj, sb, i + 2);
                sb.append("\n");
                while (i2 < i) {
                    sb.append(' ');
                    i2++;
    ...
    private static void zzc(zzabd zzabd, StringBuilder sb, int i) {
        String str;
        boolean z;
        String str2;
        String str3;
        ...
        for (Method method : zzabd.getClass().getDeclaredMethods()) {
        ...
        for (String str4 : treeSet) {
            ...
            if (substring.endsWith("List") && !substring.endsWith("OrBuilderList") && !substring.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zzb(sb, i, zzd(str3), zzaaa.zzA(method2, zzabd, new Object[0]));
                }
            }
            if (substring.endsWith("Map") && !substring.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zzb(sb, i, zzd(str2), zzaaa.zzA(method3, zzabd, new Object[0]));
                }
            }
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? "set".concat(valueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object zzA = zzaaa.zzA(method4, zzabd, new Object[0]);
                    if (method5 == null) {
                        if (zzA instanceof Boolean) {
                            ...
                            if (zzA instanceof String) {
                                z = zzA.equals("");
                            } else if (zzA instanceof zzyy) {
                                z = zzA.equals(zzyy.zzb);
                            } else if (zzA instanceof zzabd) {
                                if (zzA == ((zzabd) zzA).zzo()) {
                                }
                    ...
                    } else if (!((Boolean) zzaaa.zzA(method5, zzabd, new Object[0])).booleanValue()) {
                    }
                    zzb(sb, i, zzd(concat), zzA);
                }
            }
        }
        if (!(zzabd instanceof zzzx)) {
            zzace zzace = ((zzaaa) zzabd).zzc;
            if (zzace != null) {
                zzace.zzg(sb, i);
                return;
            }
