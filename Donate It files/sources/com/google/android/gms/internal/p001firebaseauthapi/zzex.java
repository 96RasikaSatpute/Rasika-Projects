...
public final class zzex extends zzaaa<zzex, zzew> implements zzabe {
    ...
    static {
        zzex zzex = new zzex();
        zzf = zzex;
        zzaaa.zzy(zzex.class, zzex);
    }

    private zzex() {
    }

    public static zzex zzc(zzyy zzyy, zzzn zzzn) throws zzaai {
        return (zzex) zzaaa.zzE(zzf, zzyy, zzzn);
    }
