...
final class zzza extends zzzb {
    ...
    /* synthetic */ zzza(byte[] bArr, int i, int i2, boolean z, zzyz zzyz) {
        super((zzyz) null);
        this.zzc = bArr;
        this.zzd = i2;
        this.zzf = 0;
    ...
    public final void zzb(int i) throws zzaai {
        if (this.zzg != i) {
            throw zzaai.zzf();
        }
    }
    ...
    public final String zze() throws IOException {
        ...
        if (zzh2 > 0) {
            ...
            int i2 = this.zzf;
            if (zzh2 <= i - i2) {
                String str = new String(this.zzc, i2, zzh2, zzaag.zza);
                this.zzf += zzh2;
                return str;
            }
        }
    ...
    public final String zzf() throws IOException {
        ...
        if (zzh2 > 0) {
            ...
            int i2 = this.zzf;
            if (zzh2 <= i - i2) {
                String zze2 = zzacs.zze(this.zzc, i2, zzh2);
                this.zzf += zzh2;
                return zze2;
            }
        }
    ...
    public final zzyy zzg() throws IOException {
        int zzh2 = zzh();
        if (zzh2 > 0) {
            int i = this.zzd;
            int i2 = this.zzf;
            if (zzh2 <= i - i2) {
                zzyy zzl = zzyy.zzl(this.zzc, i2, zzh2);
                this.zzf += zzh2;
                return zzl;
            }
        }
        ...
        if (zzh2 > 0) {
            ...
            if (zzh2 <= i3 - i4) {
                int i5 = zzh2 + i4;
                this.zzf = i5;
                return zzyy.zzn(Arrays.copyOfRange(this.zzc, i4, i5));
            }
        }
        if (zzh2 <= 0) {
            throw zzaai.zzc();
    ...
    public final int zzm(int i) throws zzaai {
        if (i >= 0) {
            int i2 = i + this.zzf;
            int i3 = this.zzh;
            if (i2 <= i3) {
    ...
    public final int zzh() throws java.io.IOException {
        ...
        L_0x006f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p001firebaseauthapi.zzza.zzh():int");
    }
