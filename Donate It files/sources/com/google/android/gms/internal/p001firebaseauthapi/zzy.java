...
final class zzy extends zzac {
    ...
    public final int zzc(int i) {
        ...
        if (i < 0 || i > length) {
            if (i < 0) {
                str = zzaf.zzd("%s (%s) must not be negative", "index", Integer.valueOf(i));
            } else if (length < 0) {
                ...
                str = zzaf.zzd("%s (%s) must not be greater than size (%s)", "index", Integer.valueOf(i), Integer.valueOf(length));
            }
