...
final class zzdo implements zzkg {
    ...
    zzdo(zzih zzih) throws GeneralSecurityException {
        ...
        if (zza2.equals(zzbn.zzb)) {
            try {
                zzfv zzb2 = zzfv.zzb(zzih.zzb(), zzzn.zza());
            ...
            try {
                zzex zzc2 = zzex.zzc(zzih.zzb(), zzzn.zza());
            ...
            try {
                zzgh zzb3 = zzgh.zzb(zzih.zzb(), zzzn.zza());
    ...
    public final zzdp zzb(byte[] bArr) throws GeneralSecurityException {
        if (bArr.length != this.zzb) {
            ...
            zzfr zzd2 = zzfs.zzd();
            zzd2.zzm(this.zzc);
            zzd2.zzb(zzyy.zzl(bArr, 0, this.zzb));
            ...
            zze2.zzc(zzyy.zzm(copyOfRange));
            zzhq zze3 = zzhr.zze();
            zze3.zzm(this.zzd.zzc());
            zze3.zzc(zzyy.zzm(copyOfRange2));
            zzet zze4 = zzeu.zze();
            ...
            zzgd zzd3 = zzge.zzd();
            zzd3.zzm(this.zzf);
            zzd3.zzb(zzyy.zzl(bArr, 0, this.zzb));
