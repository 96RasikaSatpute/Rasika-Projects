...
public final class zzjt implements zzkx {
    private static final ThreadLocal<Cipher> zza = new zzjs();
    private final SecretKeySpec zzb;
    private final int zzc;
    private final int zzd;

    public zzjt(byte[] bArr, int i) throws GeneralSecurityException {
