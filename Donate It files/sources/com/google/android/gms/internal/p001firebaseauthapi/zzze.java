...
abstract class zzze extends zzzi {
    final byte[] zza;
    final int zzb;
    int zzc;
    int zzd;
    ...
    public final void zzd(int i) {
        if (zzzi.zzb) {
            ...
            while ((i & -128) != 0) {
                ...
                int i2 = this.zzc;
                this.zzc = i2 + 1;
                zzacn.zzp(bArr, (long) i2, (byte) ((i & 127) | 128));
                i >>>= 7;
            }
            byte[] bArr2 = this.zza;
            int i3 = this.zzc;
            this.zzc = i3 + 1;
            zzacn.zzp(bArr2, (long) i3, (byte) i);
    ...
    public final void zze(long j) {
        if (zzzi.zzb) {
            ...
            while ((j & -128) != 0) {
                ...
                int i = this.zzc;
                this.zzc = i + 1;
                zzacn.zzp(bArr, (long) i, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr2 = this.zza;
            int i2 = this.zzc;
            this.zzc = i2 + 1;
            zzacn.zzp(bArr2, (long) i2, (byte) ((int) j));
