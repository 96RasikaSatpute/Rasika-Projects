...
final class zzrs extends zzvc<Void, zzg> {
    private final zznn zza;

    public zzrs(PhoneAuthCredential phoneAuthCredential, String str) {
        super(2);
    ...
    public final TaskApiCall<zztr, Void> zzb() {
        return TaskApiCall.builder().run(new zzrr(this)).build();
    }
    ...
    public final /* synthetic */ void zzd(zztr zztr, TaskCompletionSource taskCompletionSource) throws RemoteException {
        ...
        zztr.zzq().zzv(this.zza, this.zzc);
    }
}
