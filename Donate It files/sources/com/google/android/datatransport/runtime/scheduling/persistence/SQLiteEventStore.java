...
public class SQLiteEventStore implements EventStore, SynchronizationGuard {
    ...
    private Map<Long, Set<Metadata>> loadMetadata(SQLiteDatabase db, List<PersistedEvent> events) {
        ...
        whereClause.append(')');
        tryWithCursor(db.query("event_metadata", new String[]{"event_id", "name", "value"}, whereClause.toString(), (String[]) null, (String) null, (String) null, (String) null), SQLiteEventStore$$Lambda$17.lambdaFactory$(metadataIndex));
