...
final class CctTransportBackend implements TransportBackend {
    ...
    public HttpResponse doSend(HttpRequest request) throws IOException {
        ...
        Logging.d(LOG_TAG, "Making request to: %s", (Object) request.url);
        ...
        connection.setRequestProperty("User-Agent", String.format("datatransport/%s android/", new Object[]{BuildConfig.VERSION_NAME}));
        ...
        try {
            ...
            try {
                ...
                Logging.i(LOG_TAG, "Content-Type: " + connection.getHeaderField(CONTENT_TYPE_HEADER_KEY));
                ...
                try {
                    inputStream = maybeUnGzip(connStream, connection.getHeaderField(CONTENT_ENCODING_HEADER_KEY));
    ...
    public BackendResponse send(BackendRequest request) {
        ...
        try {
            HttpResponse response = (HttpResponse) Retries.retry(5, new HttpRequest(actualEndPoint, requestBody, apiKey), CctTransportBackend$$Lambda$1.lambdaFactory$(this), CctTransportBackend$$Lambda$4.lambdaFactory$());
    ...
    static /* synthetic */ HttpRequest lambda$send$0(HttpRequest req, HttpResponse resp) {
        ...
        Logging.d(LOG_TAG, "Following redirect to: %s", (Object) resp.redirectUrl);
