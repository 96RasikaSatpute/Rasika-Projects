...
public class PolyUtil {
    ...
    public static double distanceToLine(LatLng p, LatLng start, LatLng end) {
        ...
        double s2lat = Math.toRadians(latLng3.latitude);
        ...
        double d4 = s1lng;
        double d5 = s2lat;
        return SphericalUtil.computeDistanceBetween(latLng, new LatLng(latLng2.latitude + ((latLng3.latitude - latLng2.latitude) * u), latLng2.longitude + ((latLng3.longitude - latLng2.longitude) * u)));
    }
