...
public class GmsRpc {
    ...
    public GmsRpc(FirebaseApp app2, Metadata metadata2, Provider<UserAgentPublisher> userAgentPublisher2, Provider<HeartBeatInfo> heartbeatInfo2, FirebaseInstallationsApi firebaseInstallations2) {
    ...
    public Task<?> deleteInstanceId(String instanceId) {
        ...
        return extractResponseWhenComplete(startRpc(instanceId, "*", "*", bundle));
    }

    public Task<?> deleteToken(String instanceId, String authorizedEntity, String scope) {
        Bundle bundle = new Bundle();
        bundle.putString("delete", DiskLruCache.VERSION_1);
        return extractResponseWhenComplete(startRpc(instanceId, authorizedEntity, scope, bundle));
    }

    public Task<String> getToken(String instanceId, String authorizedEntity, String scope) {
        return extractResponseWhenComplete(startRpc(instanceId, authorizedEntity, scope, new Bundle()));
    }
    ...
    public Task<?> subscribeToTopic(String instanceId, String cachedToken, String topic) {
        ...
        return extractResponseWhenComplete(startRpc(instanceId, cachedToken, valueOf2.length() != 0 ? "/topics/".concat(valueOf2) : new String("/topics/"), bundle));
    }
