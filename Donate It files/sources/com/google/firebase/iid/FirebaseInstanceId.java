...
public class FirebaseInstanceId {
    ...
    @Deprecated
    public void deleteToken(String senderId, String scope) throws IOException {
        checkRequiredFirebaseOptions(this.app);
        if (Looper.getMainLooper() != Looper.myLooper()) {
            String rationaliseScope = rationaliseScope(scope);
            awaitTask(this.rpc.deleteToken(getIdWithoutTriggeringSync(), senderId, rationaliseScope));
            store.deleteToken(getSubtype(), senderId, rationaliseScope);
            return;
        }
        throw new IOException("MAIN_THREAD");
    }
    ...
    public static FirebaseInstanceId getInstance(FirebaseApp app2) {
        checkRequiredFirebaseOptions(app2);
        FirebaseInstanceId firebaseInstanceId = (FirebaseInstanceId) app2.get(FirebaseInstanceId.class);
    ...
    @Deprecated
    public String getToken(String senderId, String scope) throws IOException {
        checkRequiredFirebaseOptions(this.app);
        if (Looper.getMainLooper() != Looper.myLooper()) {
            return ((InstanceIdResult) awaitTask(getInstanceId(senderId, scope))).getToken();
        }
        throw new IOException("MAIN_THREAD");
    }
