...
public class NotificationParams {
    ...
    public boolean getBoolean(String key) {
        ...
        return DiskLruCache.VERSION_1.equals(key2) || Boolean.parseBoolean(key2);
    }
    ...
    public static boolean isNotification(Bundle data2) {
        return DiskLruCache.VERSION_1.equals(data2.getString(Constants.MessageNotificationKeys.ENABLE_NOTIFICATION)) || DiskLruCache.VERSION_1.equals(data2.getString(keyWithOldPrefix(Constants.MessageNotificationKeys.ENABLE_NOTIFICATION)));
    }
}
