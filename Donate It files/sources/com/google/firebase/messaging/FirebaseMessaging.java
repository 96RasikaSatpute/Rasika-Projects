...
public class FirebaseMessaging {
    ...
    public Task<Void> subscribeToTopic(String topic) {
        return this.topicsSubscriberTask.onSuccessTask(new FirebaseMessaging$$Lambda$6(topic));
    }
    ...
    public Task<Void> unsubscribeFromTopic(String topic) {
        return this.topicsSubscriberTask.onSuccessTask(new FirebaseMessaging$$Lambda$7(topic));
    }
