...
public class RecaptchaActivity extends FragmentActivity implements zzty {
    ...
    public final void onResume() {
        ...
        if ("android.intent.action.VIEW".equals(getIntent().getAction())) {
            ...
            try {
                new zztw(packageName, Hex.bytesToStringUppercase(AndroidUtilsLight.getPackageCertificateHashBytes(this, packageName)).toLowerCase(Locale.US), getIntent(), this).executeOnExecutor(zzc, new Void[0]);
