...
public final class zzx extends FirebaseUser {
    ...
    public final String getTenantId() {
        Map map;
        zzwv zzwv = this.zza;
        if (zzwv == null || zzwv.zze() == null || (map = (Map) zzay.zza(this.zza.zze()).getClaims().get(FirebaseAuthProvider.PROVIDER_ID)) == null) {
            return null;
        }
    ...
    public final boolean isAnonymous() {
        ...
        if (bool == null || bool.booleanValue()) {
            zzwv zzwv = this.zza;
            if (zzwv != null) {
                str = zzay.zza(zzwv.zze()).getSignInProvider();
            } else {
                str = "";
            }
            boolean z = false;
    ...
    public final void zzf(zzwv zzwv) {
        this.zza = (zzwv) Preconditions.checkNotNull(zzwv);
    }
    ...
    zzx(zzwv zzwv, zzt zzt, String str, String str2, List<zzt> list, List<String> list2, String str3, Boolean bool, zzz zzz, boolean z, zze zze2, zzbb zzbb) {
        this.zza = zzwv;
        this.zzb = zzt;
        this.zzc = str;
        this.zzd = str2;
