...
class EventBus implements Subscriber, Publisher {
    ...
    public void publish(com.google.firebase.events.Event<?> r6) {
        /*
            ...
            monitor-enter(r5)
            java.util.Queue<com.google.firebase.events.Event<?>> r0 = r5.pendingEvents     // Catch:{ all -> 0x0032 }
        ...
        L_0x0016:
            ...
            java.lang.Runnable r4 = com.google.firebase.components.EventBus$$Lambda$1.lambdaFactory$(r1, r2)
            r3.execute(r4)
            goto L_0x0016
        L_0x0031:
            return
