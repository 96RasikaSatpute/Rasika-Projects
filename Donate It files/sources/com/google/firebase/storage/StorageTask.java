...
public abstract class StorageTask<ResultT extends ProvideError> extends ControllableTask<ResultT> {
    ...
    public boolean tryChangeState(int[] r9, boolean r10) {
        ...
        L_0x0007:
            ...
            monitor-enter(r1)
            int r2 = r9.length     // Catch:{ all -> 0x0102 }
            r3 = 0
            r4 = r3
        L_0x000d:
            if (r4 >= r2) goto L_0x00c9
            r5 = r9[r4]     // Catch:{ all -> 0x0102 }
            int r6 = r8.getInternalState()     // Catch:{ all -> 0x0102 }
            java.lang.Integer r6 = java.lang.Integer.valueOf(r6)     // Catch:{ all -> 0x0102 }
            java.lang.Object r6 = r0.get(r6)     // Catch:{ all -> 0x0102 }
            java.util.HashSet r6 = (java.util.HashSet) r6     // Catch:{ all -> 0x0102 }
            if (r6 == 0) goto L_0x00c5
            java.lang.Integer r7 = java.lang.Integer.valueOf(r5)     // Catch:{ all -> 0x0102 }
            boolean r7 = r6.contains(r7)     // Catch:{ all -> 0x0102 }
            if (r7 == 0) goto L_0x00c5
            r8.currentState = r5     // Catch:{ all -> 0x0102 }
            int r2 = r8.currentState     // Catch:{ all -> 0x0102 }
            r3 = 2
            ...
            goto L_0x0065
        L_0x0046:
            r8.onCanceled()     // Catch:{ all -> 0x0102 }
            goto L_0x0065
        L_0x004a:
            r8.onSuccess()     // Catch:{ all -> 0x0102 }
            goto L_0x0065
        L_0x004e:
            r8.onFailure()     // Catch:{ all -> 0x0102 }
            goto L_0x0065
        L_0x0052:
            r8.onPaused()     // Catch:{ all -> 0x0102 }
            goto L_0x0065
        L_0x0056:
            r8.onProgress()     // Catch:{ all -> 0x0102 }
            goto L_0x0065
        L_0x005a:
            com.google.firebase.storage.StorageTaskManager r2 = com.google.firebase.storage.StorageTaskManager.getInstance()     // Catch:{ all -> 0x0102 }
            r2.ensureRegistered(r8)     // Catch:{ all -> 0x0102 }
            r8.onQueued()     // Catch:{ all -> 0x0102 }
        L_0x0065:
            com.google.firebase.storage.TaskListenerImpl<com.google.android.gms.tasks.OnSuccessListener<? super ResultT>, ResultT> r2 = r8.successManager     // Catch:{ all -> 0x0102 }
            r2.onInternalStateChanged()     // Catch:{ all -> 0x0102 }
            com.google.firebase.storage.TaskListenerImpl<com.google.android.gms.tasks.OnFailureListener, ResultT> r2 = r8.failureManager     // Catch:{ all -> 0x0102 }
            r2.onInternalStateChanged()     // Catch:{ all -> 0x0102 }
            com.google.firebase.storage.TaskListenerImpl<com.google.android.gms.tasks.OnCanceledListener, ResultT> r2 = r8.cancelManager     // Catch:{ all -> 0x0102 }
            r2.onInternalStateChanged()     // Catch:{ all -> 0x0102 }
            com.google.firebase.storage.TaskListenerImpl<com.google.android.gms.tasks.OnCompleteListener<ResultT>, ResultT> r2 = r8.completeListener     // Catch:{ all -> 0x0102 }
            r2.onInternalStateChanged()     // Catch:{ all -> 0x0102 }
            com.google.firebase.storage.TaskListenerImpl<com.google.firebase.storage.OnPausedListener<? super ResultT>, ResultT> r2 = r8.pausedManager     // Catch:{ all -> 0x0102 }
            r2.onInternalStateChanged()     // Catch:{ all -> 0x0102 }
            com.google.firebase.storage.TaskListenerImpl<com.google.firebase.storage.OnProgressListener<? super ResultT>, ResultT> r2 = r8.progressManager     // Catch:{ all -> 0x0102 }
            r2.onInternalStateChanged()     // Catch:{ all -> 0x0102 }
            java.lang.String r2 = "StorageTask"
            r3 = 3
            boolean r2 = android.util.Log.isLoggable(r2, r3)     // Catch:{ all -> 0x0102 }
            ...
            java.lang.String r4 = r8.getStateString((int) r5)     // Catch:{ all -> 0x0102 }
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x0102 }
            java.lang.String r4 = " isUser: "
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x0102 }
            java.lang.StringBuilder r3 = r3.append(r10)     // Catch:{ all -> 0x0102 }
            java.lang.String r4 = " from state:"
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x0102 }
            int r4 = r8.currentState     // Catch:{ all -> 0x0102 }
            java.lang.String r4 = r8.getStateString((int) r4)     // Catch:{ all -> 0x0102 }
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x0102 }
            java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0102 }
            android.util.Log.d(r2, r3)     // Catch:{ all -> 0x0102 }
        L_0x00c2:
        ...
        L_0x00c9:
            ...
            java.lang.String r5 = r8.getStateString((int[]) r9)     // Catch:{ all -> 0x0102 }
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0102 }
            java.lang.String r5 = " isUser: "
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0102 }
            java.lang.StringBuilder r4 = r4.append(r10)     // Catch:{ all -> 0x0102 }
            java.lang.String r5 = " from state:"
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0102 }
            int r5 = r8.currentState     // Catch:{ all -> 0x0102 }
            java.lang.String r5 = r8.getStateString((int) r5)     // Catch:{ all -> 0x0102 }
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0102 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0102 }
            android.util.Log.w(r2, r4)     // Catch:{ all -> 0x0102 }
            monitor-exit(r1)     // Catch:{ all -> 0x0102 }
            return r3
        L_0x0102:
            r2 = move-exception
