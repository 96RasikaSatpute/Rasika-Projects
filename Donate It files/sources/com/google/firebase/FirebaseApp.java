...
public class FirebaseApp {
    ...
    protected FirebaseApp(Context applicationContext2, String name2, FirebaseOptions options2) {
        ...
        this.componentRuntime = ComponentRuntime.builder(UI_EXECUTOR).addLazyComponentRegistrars(ComponentDiscovery.forContext(applicationContext2, ComponentDiscoveryService.class).discoverLazy()).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponent(Component.of(applicationContext2, Context.class, new Class[0])).addComponent(Component.of(this, FirebaseApp.class, new Class[0])).addComponent(Component.of(options2, FirebaseOptions.class, new Class[0])).build();
