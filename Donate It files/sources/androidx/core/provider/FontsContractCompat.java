...
public class FontsContractCompat {
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r9, final androidx.core.provider.FontRequest r10, final androidx.core.content.res.ResourcesCompat.FontCallback r11, final android.os.Handler r12, boolean r13, int r14, final int r15) {
        ...
        L_0x0048:
            ...
            androidx.core.provider.SelfDestructiveThread r4 = sBackgroundThread     // Catch:{ InterruptedException -> 0x005b }
            java.lang.Object r4 = r4.postAndWait(r2, r14)     // Catch:{ InterruptedException -> 0x005b }
            androidx.core.provider.FontsContractCompat$TypefaceResult r4 = (androidx.core.provider.FontsContractCompat.TypefaceResult) r4     // Catch:{ InterruptedException -> 0x005b }
        ...
        L_0x0066:
            ...
            monitor-enter(r5)
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r6 = sPendingReplies     // Catch:{ all -> 0x0095 }
            java.lang.Object r7 = r6.get(r0)     // Catch:{ all -> 0x0095 }
            java.util.ArrayList r7 = (java.util.ArrayList) r7     // Catch:{ all -> 0x0095 }
            if (r7 == 0) goto L_0x007b
            if (r4 == 0) goto L_0x0079
            r7.add(r4)     // Catch:{ all -> 0x0095 }
        L_0x0079:
