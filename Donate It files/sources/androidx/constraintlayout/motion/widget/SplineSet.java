...
public abstract class SplineSet {
    ...
    static androidx.constraintlayout.motion.widget.SplineSet makeSpline(java.lang.String r1) {
        ...
        L_0x00f6:
            ...
            return r0
        L_0x00fc:
            androidx.constraintlayout.motion.widget.SplineSet$PivotYset r0 = new androidx.constraintlayout.motion.widget.SplineSet$PivotYset
            r0.<init>()
            return r0
        L_0x0102:
            androidx.constraintlayout.motion.widget.SplineSet$PivotXset r0 = new androidx.constraintlayout.motion.widget.SplineSet$PivotXset
            r0.<init>()
            return r0
        L_0x0108:
