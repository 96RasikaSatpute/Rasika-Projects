    ...
    class Model {
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            if (child.mTop.mTarget != null) {
                str2 = ExifInterface.GPS_DIRECTION_TRUE + (child.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? ExifInterface.GPS_DIRECTION_TRUE : str5);
            } else {
                str2 = str6;
            }
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                String str2 = "_";
                StringBuilder append = new StringBuilder().append((("" + (child.mTop.mTarget != null ? ExifInterface.GPS_DIRECTION_TRUE : str2)) + (child.mBottom.mTarget != null ? "B" : str2)) + (child.mLeft.mTarget != null ? "L" : str2));
                if (child.mRight.mTarget != null) {
                    str2 = "R";
                }
