...
public final class Util {
    ...
    public static final String toHexString(byte $this$toHexString) {
        int $this$and$iv = $this$toHexString;
        return new String(new char[]{ByteStringKt.getHEX_DIGIT_CHARS()[($this$and$iv >> 4) & 15], ByteStringKt.getHEX_DIGIT_CHARS()[15 & $this$and$iv]});
    }
