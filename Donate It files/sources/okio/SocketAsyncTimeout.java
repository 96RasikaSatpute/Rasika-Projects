...
final class SocketAsyncTimeout extends AsyncTimeout {
    ...
    public void timedOut() {
        try {
            ...
            this.logger.log(Level.WARNING, "Failed to close timed out socket " + this.socket, e);
        } catch (AssertionError e2) {
            if (Okio.isAndroidGetsocknameError(e2)) {
                this.logger.log(Level.WARNING, "Failed to close timed out socket " + this.socket, e2);
                return;
            }
            throw e2;
        }
