    ...
    public static final class Companion {
        ...
        private final void buildTrieRecursive(long nodeOffset, Buffer node, int byteStringOffset, List<? extends ByteString> byteStrings, int fromIndex, int toIndex, List<Integer> indexes) {
            ...
            if (i3 < i2) {
                ...
                int i5 = fromIndex;
                ByteString from4 = (ByteString) list.get(i5);
                ByteString to = (ByteString) list.get(i2 - 1);
                if (i == from4.size()) {
                    int prefixIndex3 = list2.get(i5).intValue();
                    int fromIndex4 = i5 + 1;
                ...
                if (from.getByte(i) != to.getByte(i)) {
                    ...
                    for (int i8 = fromIndex2; i8 < i2; i8++) {
                        int rangeByte = ((ByteString) list.get(i8)).getByte(i);
                        if (i8 == fromIndex2 || rangeByte != ((ByteString) list.get(i8 - 1)).getByte(i)) {
                    ...
                    while (rangeStart < i2) {
                        ...
                        while (true) {
                            ...
                            if (rangeByte2 != ((ByteString) list.get(i9)).getByte(i)) {
                                int i10 = i9;
                                break;
                            } else {
                                i9++;
                ...
                for (int i18 = i; i18 < i17; i18++) {
                    buffer.writeInt((int) from2.getByte(i18) & UByte.MAX_VALUE);
                }
                if (fromIndex5 + 1 == i2) {
                    if (i + scanByteCount == ((ByteString) list.get(fromIndex5)).size()) {
                        z = true;
                    }
                    if (z) {
                        int fromIndex6 = fromIndex5;
                        buffer.writeInt(indexes.get(fromIndex6).intValue());
                        int i19 = fromIndex6;
                ...
                int i21 = scanByteCount;
                buildTrieRecursive(childNodesOffset2, childNodes3, i + scanByteCount, byteStrings, fromIndex7, toIndex, indexes);
