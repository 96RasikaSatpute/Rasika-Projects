...
public final class UnsignedKt {
    ...
    public static final int m314uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m88constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }
    ...
    public static final long m316ulongDivideeb3DHEI(long v1, long v2) {
        ...
        if (divisor < 0) {
            ...
            if (ulongCompare(ULong.m157constructorimpl(dividend - (quotient * divisor)), ULong.m157constructorimpl(divisor)) < 0) {
                i = 0;
            }
            return ULong.m157constructorimpl(((long) i) + quotient);
        }
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        return UInt.m88constructorimpl(UInt.m88constructorimpl((int) (v - d)) + UInt.m88constructorimpl(Integer.MAX_VALUE));
    }
