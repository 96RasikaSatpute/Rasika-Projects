...
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1005plusAssignLRDsOJo(double duration) {
        long newReading;
        double delta = Duration.m990toDoubleimpl(duration, getUnit());
    ...
    private final void m1004overflowLRDsOJo(double duration) {
        throw new IllegalStateException("TestTimeSource will overflow if its reading " + this.reading + "ns is advanced by " + Duration.m996toStringimpl(duration) + '.');
    }
}
