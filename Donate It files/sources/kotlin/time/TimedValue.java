...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1008copyRFiDyg4$default(TimedValue timedValue, T t, double d, int i, Object obj) {
        if ((i & 1) != 0) {
            t = timedValue.value;
        }
        if ((i & 2) != 0) {
        ...
        return timedValue.m1009copyRFiDyg4(t, d);
    }
    ...
    public final TimedValue<T> m1009copyRFiDyg4(T t, double d) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m996toStringimpl(this.duration) + ")";
    }
