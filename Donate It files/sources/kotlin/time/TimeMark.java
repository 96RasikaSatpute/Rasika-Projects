...
public abstract class TimeMark {
    ...
    public TimeMark m1007plusLRDsOJo(double duration) {
        return new AdjustedTimeMark(this, duration, (DefaultConstructorMarker) null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1006minusLRDsOJo(double duration) {
        return m1007plusLRDsOJo(Duration.m999unaryMinusimpl(duration));
    }

    public final boolean hasPassedNow() {
        return !Duration.m979isNegativeimpl(elapsedNow());
    }
