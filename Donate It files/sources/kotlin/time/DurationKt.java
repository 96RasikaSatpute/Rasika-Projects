...
public final class DurationKt {
    ...
    public static final double toDuration(double $this$toDuration, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m958constructorimpl(DurationUnitKt.convertDurationUnit($this$toDuration, unit, TimeUnit.NANOSECONDS));
    }
    ...
    private static final double m1003timesmvk6XK0(int $this$times, double duration) {
        return Duration.m985timesimpl(duration, $this$times);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m1002timeskIfJnKk(double $this$times, double duration) {
        return Duration.m984timesimpl(duration, $this$times);
    }
}
