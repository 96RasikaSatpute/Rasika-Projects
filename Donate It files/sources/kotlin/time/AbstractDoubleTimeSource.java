...
public abstract class AbstractDoubleTimeSource implements TimeSource {
    ...
    private static final class DoubleTimeMark extends TimeMark {
        ...
        private DoubleTimeMark(double startedAt2, AbstractDoubleTimeSource timeSource2, double offset2) {
            this.startedAt = startedAt2;
            this.timeSource = timeSource2;
            this.offset = offset2;
        }

        public /* synthetic */ DoubleTimeMark(double startedAt2, AbstractDoubleTimeSource timeSource2, double offset2, DefaultConstructorMarker $constructor_marker) {
        ...
        public TimeMark m953plusLRDsOJo(double duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m982plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }
    }

    public TimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.getZERO(), (DefaultConstructorMarker) null);
    }
}
