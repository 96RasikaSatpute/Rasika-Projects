...
final class AdjustedTimeMark extends TimeMark {
    ...
    public double elapsedNow() {
        return Duration.m981minusLRDsOJo(this.mark.elapsedNow(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m955plusLRDsOJo(double duration) {
        return new AdjustedTimeMark(this.mark, Duration.m982plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
