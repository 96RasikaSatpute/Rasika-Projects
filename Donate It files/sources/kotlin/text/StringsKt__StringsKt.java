...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final CharSequence replaceRange(CharSequence $this$replaceRange, int startIndex, int endIndex, CharSequence replacement) {
        ...
        if (endIndex >= startIndex) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(sb.append($this$replaceRange, 0, startIndex), "this.append(value, startIndex, endIndex)");
            sb.append(replacement);
            Intrinsics.checkExpressionValueIsNotNull(sb.append($this$replaceRange, endIndex, $this$replaceRange.length()), "this.append(value, startIndex, endIndex)");
            return sb;
        }
    ...
    public static final CharSequence removeRange(CharSequence $this$removeRange, int startIndex, int endIndex) {
        ...
        if (endIndex < startIndex) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(sb.append($this$removeRange, 0, startIndex), "this.append(value, startIndex, endIndex)");
            Intrinsics.checkExpressionValueIsNotNull(sb.append($this$removeRange, endIndex, $this$removeRange.length()), "this.append(value, startIndex, endIndex)");
            return sb;
        }
    }
