...
public final class UStringsKt {
    ...
    public static final String m950toStringLxnNnR4(byte $this$toString, int radix) {
    ...
    public static final String m952toStringolVBNx4(short $this$toString, int radix) {
    ...
    public static final String m951toStringV7xB4Y4(int $this$toString, int radix) {
    ...
    public static final String m949toStringJSWoG40(long $this$toString, int radix) {
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        for (int i = start; i < length; i++) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m314uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m157constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m316ulongDivideeb3DHEI(-1, uradix);
                if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            long result2 = ULong.m157constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m157constructorimpl(ULong.m157constructorimpl(((long) UInt.m88constructorimpl(digit)) & 4294967295L) + result2);
