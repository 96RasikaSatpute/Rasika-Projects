...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    public final void internalStructure$kotlin_stdlib(Function2<? super Integer, ? super Object[], Unit> structure) {
        ...
        int i = this.head;
        if (i < tail) {
            ArraysKt.copyInto$default(this.elementData, elements, 0, i, tail, 2, (Object) null);
            structure.invoke(Integer.valueOf(this.head), elements);
            return;
        }
        ArraysKt.copyInto$default(this.elementData, elements, 0, i, 0, 10, (Object) null);
        Object[] objArr = this.elementData;
        ArraysKt.copyInto((T[]) objArr, (T[]) elements, objArr.length - this.head, 0, tail);
        structure.invoke(Integer.valueOf(this.head - this.elementData.length), elements);
    }
}
