...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int start, int endInclusive, int step2) {
        if (step2 == 0) {
            ...
            this.first = start;
            this.last = UProgressionUtilKt.m897getProgressionLastElementNkh28Cs(start, endInclusive, step2);
            this.step = step2;
        } else {
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(UInt.m125toStringimpl(this.first)).append("..").append(UInt.m125toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder().append(UInt.m125toStringimpl(this.first)).append(" downTo ").append(UInt.m125toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m911fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
