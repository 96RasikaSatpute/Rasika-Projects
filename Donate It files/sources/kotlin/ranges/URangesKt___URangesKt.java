...
class URangesKt___URangesKt {
    ...
    public static final UInt randomOrNull(UIntRange $this$randomOrNull, Random random) {
        ...
        return UInt.m82boximpl(URandomKt.nextUInt(random, $this$randomOrNull));
    }
    ...
    public static final ULong randomOrNull(ULongRange $this$randomOrNull, Random random) {
        ...
        return ULong.m151boximpl(URandomKt.nextULong(random, $this$randomOrNull));
    }

    /* renamed from: contains-biwQdVI  reason: not valid java name */
    private static final boolean m934containsbiwQdVI(UIntRange $this$contains, UInt element) {
        Intrinsics.checkParameterIsNotNull($this$contains, "$this$contains");
        return element != null && $this$contains.m912containsWZ4Q5Ns(element.m131unboximpl());
    }

    /* renamed from: contains-GYNo2lE  reason: not valid java name */
    private static final boolean m930containsGYNo2lE(ULongRange $this$contains, ULong element) {
        Intrinsics.checkParameterIsNotNull($this$contains, "$this$contains");
        return element != null && $this$contains.m914containsVKZWuLQ(element.m200unboximpl());
    }

    /* renamed from: contains-68kG9v0  reason: not valid java name */
    public static final boolean m929contains68kG9v0(UIntRange $this$contains, byte value) {
        Intrinsics.checkParameterIsNotNull($this$contains, "$this$contains");
        return $this$contains.m912containsWZ4Q5Ns(UInt.m88constructorimpl(value & UByte.MAX_VALUE));
    }

    /* renamed from: contains-ULb-yJY  reason: not valid java name */
    public static final boolean m932containsULbyJY(ULongRange $this$contains, byte value) {
        Intrinsics.checkParameterIsNotNull($this$contains, "$this$contains");
        return $this$contains.m914containsVKZWuLQ(ULong.m157constructorimpl(((long) value) & 255));
    }

    /* renamed from: contains-Gab390E  reason: not valid java name */
    public static final boolean m931containsGab390E(ULongRange $this$contains, int value) {
        Intrinsics.checkParameterIsNotNull($this$contains, "$this$contains");
        return $this$contains.m914containsVKZWuLQ(ULong.m157constructorimpl(((long) value) & 4294967295L));
    }

    /* renamed from: contains-fz5IDCE  reason: not valid java name */
    public static final boolean m935containsfz5IDCE(UIntRange $this$contains, long value) {
        Intrinsics.checkParameterIsNotNull($this$contains, "$this$contains");
        return ULong.m157constructorimpl(value >>> 32) == 0 && $this$contains.m912containsWZ4Q5Ns(UInt.m88constructorimpl((int) value));
    }

    /* renamed from: contains-ZsK3CEQ  reason: not valid java name */
    public static final boolean m933containsZsK3CEQ(UIntRange $this$contains, short value) {
        Intrinsics.checkParameterIsNotNull($this$contains, "$this$contains");
        return $this$contains.m912containsWZ4Q5Ns(UInt.m88constructorimpl(65535 & value));
    }

    /* renamed from: contains-uhHAxoY  reason: not valid java name */
    public static final boolean m936containsuhHAxoY(ULongRange $this$contains, short value) {
        Intrinsics.checkParameterIsNotNull($this$contains, "$this$contains");
        return $this$contains.m914containsVKZWuLQ(ULong.m157constructorimpl(((long) value) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    /* renamed from: downTo-Kr8caGY  reason: not valid java name */
    public static final UIntProgression m939downToKr8caGY(byte $this$downTo, byte to) {
        return UIntProgression.Companion.m911fromClosedRangeNkh28Cs(UInt.m88constructorimpl($this$downTo & UByte.MAX_VALUE), UInt.m88constructorimpl(to & UByte.MAX_VALUE), -1);
    }

    /* renamed from: downTo-J1ME1BU  reason: not valid java name */
    public static final UIntProgression m938downToJ1ME1BU(int $this$downTo, int to) {
        return UIntProgression.Companion.m911fromClosedRangeNkh28Cs($this$downTo, to, -1);
    }

    /* renamed from: downTo-eb3DHEI  reason: not valid java name */
    public static final ULongProgression m940downToeb3DHEI(long $this$downTo, long to) {
        return ULongProgression.Companion.m913fromClosedRange7ftBX0g($this$downTo, to, -1);
    }

    /* renamed from: downTo-5PvTz6A  reason: not valid java name */
    public static final UIntProgression m937downTo5PvTz6A(short $this$downTo, short to) {
        return UIntProgression.Companion.m911fromClosedRangeNkh28Cs(UInt.m88constructorimpl($this$downTo & UShort.MAX_VALUE), UInt.m88constructorimpl(65535 & to), -1);
    }
    ...
    public static final UIntProgression reversed(UIntProgression $this$reversed) {
        ...
        return UIntProgression.Companion.m911fromClosedRangeNkh28Cs($this$reversed.getLast(), $this$reversed.getFirst(), -$this$reversed.getStep());
    }

    public static final ULongProgression reversed(ULongProgression $this$reversed) {
        Intrinsics.checkParameterIsNotNull($this$reversed, "$this$reversed");
        return ULongProgression.Companion.m913fromClosedRange7ftBX0g($this$reversed.getLast(), $this$reversed.getFirst(), -$this$reversed.getStep());
    }
    ...
    public static final UIntProgression step(UIntProgression $this$step, int step) {
        ...
        return UIntProgression.Companion.m911fromClosedRangeNkh28Cs($this$step.getFirst(), $this$step.getLast(), $this$step.getStep() > 0 ? step : -step);
    }
    ...
    public static final ULongProgression step(ULongProgression $this$step, long step) {
        ...
        return ULongProgression.Companion.m913fromClosedRange7ftBX0g($this$step.getFirst(), $this$step.getLast(), $this$step.getStep() > 0 ? step : -step);
    }

    /* renamed from: until-Kr8caGY  reason: not valid java name */
    public static final UIntRange m943untilKr8caGY(byte $this$until, byte to) {
    ...
    public static final UIntRange m942untilJ1ME1BU(int $this$until, int to) {
    ...
    public static final ULongRange m944untileb3DHEI(long $this$until, long to) {
    ...
    public static final UIntRange m941until5PvTz6A(short $this$until, short to) {
    ...
    public static final int m916coerceAtLeastJ1ME1BU(int $this$coerceAtLeast, int minimumValue) {
        return UnsignedKt.uintCompare($this$coerceAtLeast, minimumValue) < 0 ? minimumValue : $this$coerceAtLeast;
    }

    /* renamed from: coerceAtLeast-eb3DHEI  reason: not valid java name */
    public static final long m918coerceAtLeasteb3DHEI(long $this$coerceAtLeast, long minimumValue) {
        return UnsignedKt.ulongCompare($this$coerceAtLeast, minimumValue) < 0 ? minimumValue : $this$coerceAtLeast;
    }

    /* renamed from: coerceAtLeast-Kr8caGY  reason: not valid java name */
    public static final byte m917coerceAtLeastKr8caGY(byte $this$coerceAtLeast, byte minimumValue) {
    ...
    public static final short m915coerceAtLeast5PvTz6A(short $this$coerceAtLeast, short minimumValue) {
    ...
    public static final int m920coerceAtMostJ1ME1BU(int $this$coerceAtMost, int maximumValue) {
        return UnsignedKt.uintCompare($this$coerceAtMost, maximumValue) > 0 ? maximumValue : $this$coerceAtMost;
    }

    /* renamed from: coerceAtMost-eb3DHEI  reason: not valid java name */
    public static final long m922coerceAtMosteb3DHEI(long $this$coerceAtMost, long maximumValue) {
        return UnsignedKt.ulongCompare($this$coerceAtMost, maximumValue) > 0 ? maximumValue : $this$coerceAtMost;
    }

    /* renamed from: coerceAtMost-Kr8caGY  reason: not valid java name */
    public static final byte m921coerceAtMostKr8caGY(byte $this$coerceAtMost, byte maximumValue) {
    ...
    public static final short m919coerceAtMost5PvTz6A(short $this$coerceAtMost, short maximumValue) {
    ...
    public static final int m925coerceInWZ9TVnA(int $this$coerceIn, int minimumValue, int maximumValue) {
    ...
    public static final long m927coerceInsambcqE(long $this$coerceIn, long minimumValue, long maximumValue) {
    ...
    public static final byte m926coerceInb33U2AM(byte $this$coerceIn, byte minimumValue, byte maximumValue) {
    ...
    public static final short m924coerceInVKSA0NQ(short $this$coerceIn, short minimumValue, short maximumValue) {
    ...
    public static final int m928coerceInwuiCnnA(int $this$coerceIn, ClosedRange<UInt> range) {
    ...
    public static final long m923coerceInJPwROB0(long $this$coerceIn, ClosedRange<ULong> range) {
        Intrinsics.checkParameterIsNotNull(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
