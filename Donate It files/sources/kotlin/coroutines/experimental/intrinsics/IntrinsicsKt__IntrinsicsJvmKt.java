...
class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static final <T> Continuation<Unit> createCoroutineUnchecked(Function1<? super Continuation<? super T>, ? extends Object> $this$createCoroutineUnchecked, Continuation<? super T> completion) {
        ...
        if (!($this$createCoroutineUnchecked instanceof CoroutineImpl)) {
            return CoroutineIntrinsics.interceptContinuationIfNeeded(completion.getContext(), new IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnchecked$$inlined$buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt$1(completion, $this$createCoroutineUnchecked, completion));
        }
    ...
    public static final <R, T> Continuation<Unit> createCoroutineUnchecked(Function2<? super R, ? super Continuation<? super T>, ? extends Object> $this$createCoroutineUnchecked, R receiver, Continuation<? super T> completion) {
        ...
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        if (!($this$createCoroutineUnchecked instanceof CoroutineImpl)) {
            return CoroutineIntrinsics.interceptContinuationIfNeeded(completion.getContext(), new IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnchecked$$inlined$buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt$2(completion, $this$createCoroutineUnchecked, receiver, completion));
        }
    ...
    private static final <T> Continuation<Unit> buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt(Continuation<? super T> completion, Function0<? extends Object> block) {
        return CoroutineIntrinsics.interceptContinuationIfNeeded(completion.getContext(), new IntrinsicsKt__IntrinsicsJvmKt$buildContinuationByInvokeCall$continuation$1(completion, block));
    }
