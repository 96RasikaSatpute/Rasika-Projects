...
public final class KotlinExtensions$await$2$2 implements Callback<T> {
    ...
    public void onResponse(Call<T> call, Response<T> response) {
        ...
        if (response.isSuccessful()) {
            ...
            if (body == null) {
                ...
                this.$continuation.resumeWith(Result.m3constructorimpl(ResultKt.createFailure(e)));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            this.$continuation.resumeWith(Result.m3constructorimpl(body));
            return;
        }
        Result.Companion companion3 = Result.Companion;
        this.$continuation.resumeWith(Result.m3constructorimpl(ResultKt.createFailure(new HttpException(response))));
    }
    ...
    public void onFailure(Call<T> call, Throwable t) {
        ...
        Result.Companion companion = Result.Companion;
        this.$continuation.resumeWith(Result.m3constructorimpl(ResultKt.createFailure(t)));
    }
}
