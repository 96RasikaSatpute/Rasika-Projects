...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public final int m1058deprecated_size() {
        return size();
    }
    ...
    public static final class Companion {
        ...
        public final Headers m1060deprecated_of(String... namesAndValues) {
            Intrinsics.checkParameterIsNotNull(namesAndValues, "namesAndValues");
        ...
        /* renamed from: -deprecated_of  reason: not valid java name */
        public final Headers m1059deprecated_of(Map<String, String> headers) {
            Intrinsics.checkParameterIsNotNull(headers, "headers");
            return of(headers);
        }
