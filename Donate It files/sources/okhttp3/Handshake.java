...
public final class Handshake {
    ...
    public final TlsVersion m1056deprecated_tlsVersion() {
        return this.tlsVersion;
    }
    ...
    public final CipherSuite m1051deprecated_cipherSuite() {
        return this.cipherSuite;
    }
    ...
    public final List<Certificate> m1054deprecated_peerCertificates() {
    ...
    public final Principal m1055deprecated_peerPrincipal() {
    ...
    public final List<Certificate> m1052deprecated_localCertificates() {
        return this.localCertificates;
    }
    ...
    public final Principal m1053deprecated_localPrincipal() {
    ...
    public String toString() {
        ...
        StringBuilder append = new StringBuilder().append("Handshake{").append("tlsVersion=").append(this.tlsVersion).append(' ').append("cipherSuite=").append(this.cipherSuite).append(' ').append("peerCertificates=").append(((List) destination$iv$iv).toString()).append(' ').append("localCertificates=");
    ...
    public static final class Companion {
        ...
        public final Handshake m1057deprecated_get(SSLSession sslSession) throws IOException {
