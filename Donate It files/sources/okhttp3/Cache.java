...
public final class Cache implements Closeable, Flushable {
    ...
    public final File m1021deprecated_directory() {
        return this.cache.getDirectory();
    }
    ...
    private static final class Entry {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:23:0x0138, code lost:
            r2 = move-exception;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:24:0x0139, code lost:
            kotlin.io.CloseableKt.closeFinally(r1, r0);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:25:0x013c, code lost:
            throw r2;
         */
        ...
        public final void writeTo(okhttp3.internal.cache.DiskLruCache.Editor r12) throws java.io.IOException {
            /*
                ...
                r0 = 0
                okio.Sink r1 = r12.newSink(r0)
                okio.BufferedSink r1 = okio.Okio.buffer((okio.Sink) r1)
                java.io.Closeable r1 = (java.io.Closeable) r1
                r2 = 0
                java.lang.Throwable r2 = (java.lang.Throwable) r2
                r3 = r1
                okio.BufferedSink r3 = (okio.BufferedSink) r3     // Catch:{ all -> 0x0136 }
                r4 = 0
                java.lang.String r5 = r11.url     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r5 = r3.writeUtf8(r5)     // Catch:{ all -> 0x0136 }
                r6 = 10
                r5.writeByte(r6)     // Catch:{ all -> 0x0136 }
                java.lang.String r5 = r11.requestMethod     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r5 = r3.writeUtf8(r5)     // Catch:{ all -> 0x0136 }
                r5.writeByte(r6)     // Catch:{ all -> 0x0136 }
                okhttp3.Headers r5 = r11.varyHeaders     // Catch:{ all -> 0x0136 }
                int r5 = r5.size()     // Catch:{ all -> 0x0136 }
                long r7 = (long) r5     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r5 = r3.writeDecimalLong(r7)     // Catch:{ all -> 0x0136 }
                r5.writeByte(r6)     // Catch:{ all -> 0x0136 }
                okhttp3.Headers r5 = r11.varyHeaders     // Catch:{ all -> 0x0136 }
                int r5 = r5.size()     // Catch:{ all -> 0x0136 }
                r7 = r0
            L_0x0040:
                ...
                okhttp3.Headers r9 = r11.varyHeaders     // Catch:{ all -> 0x0136 }
                java.lang.String r9 = r9.name(r7)     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r9 = r3.writeUtf8(r9)     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r8 = r9.writeUtf8(r8)     // Catch:{ all -> 0x0136 }
                okhttp3.Headers r9 = r11.varyHeaders     // Catch:{ all -> 0x0136 }
                java.lang.String r9 = r9.value(r7)     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r8 = r8.writeUtf8(r9)     // Catch:{ all -> 0x0136 }
                r8.writeByte(r6)     // Catch:{ all -> 0x0136 }
                int r7 = r7 + 1
                goto L_0x0040
            L_0x0069:
                okhttp3.internal.http.StatusLine r5 = new okhttp3.internal.http.StatusLine     // Catch:{ all -> 0x0136 }
                okhttp3.Protocol r7 = r11.protocol     // Catch:{ all -> 0x0136 }
                int r9 = r11.code     // Catch:{ all -> 0x0136 }
                java.lang.String r10 = r11.message     // Catch:{ all -> 0x0136 }
                r5.<init>(r7, r9, r10)     // Catch:{ all -> 0x0136 }
                java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r5 = r3.writeUtf8(r5)     // Catch:{ all -> 0x0136 }
                r5.writeByte(r6)     // Catch:{ all -> 0x0136 }
                okhttp3.Headers r5 = r11.responseHeaders     // Catch:{ all -> 0x0136 }
                int r5 = r5.size()     // Catch:{ all -> 0x0136 }
                int r5 = r5 + 2
                long r9 = (long) r5     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r5 = r3.writeDecimalLong(r9)     // Catch:{ all -> 0x0136 }
                r5.writeByte(r6)     // Catch:{ all -> 0x0136 }
                okhttp3.Headers r5 = r11.responseHeaders     // Catch:{ all -> 0x0136 }
                int r5 = r5.size()     // Catch:{ all -> 0x0136 }
            L_0x0095:
                if (r0 >= r5) goto L_0x00bc
                okhttp3.Headers r7 = r11.responseHeaders     // Catch:{ all -> 0x0136 }
                java.lang.String r7 = r7.name(r0)     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r7 = r3.writeUtf8(r7)     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r7 = r7.writeUtf8(r8)     // Catch:{ all -> 0x0136 }
                okhttp3.Headers r9 = r11.responseHeaders     // Catch:{ all -> 0x0136 }
                java.lang.String r9 = r9.value(r0)     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r7 = r7.writeUtf8(r9)     // Catch:{ all -> 0x0136 }
                r7.writeByte(r6)     // Catch:{ all -> 0x0136 }
                int r0 = r0 + 1
                goto L_0x0095
            L_0x00bc:
                java.lang.String r0 = SENT_MILLIS     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r0 = r3.writeUtf8(r0)     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r0 = r0.writeUtf8(r8)     // Catch:{ all -> 0x0136 }
                long r9 = r11.sentRequestMillis     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r0 = r0.writeDecimalLong(r9)     // Catch:{ all -> 0x0136 }
                r0.writeByte(r6)     // Catch:{ all -> 0x0136 }
                java.lang.String r0 = RECEIVED_MILLIS     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r0 = r3.writeUtf8(r0)     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r0 = r0.writeUtf8(r8)     // Catch:{ all -> 0x0136 }
                long r7 = r11.receivedResponseMillis     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r0 = r0.writeDecimalLong(r7)     // Catch:{ all -> 0x0136 }
                r0.writeByte(r6)     // Catch:{ all -> 0x0136 }
                boolean r0 = r11.isHttps()     // Catch:{ all -> 0x0136 }
                if (r0 == 0) goto L_0x0130
                r3.writeByte(r6)     // Catch:{ all -> 0x0136 }
                okhttp3.Handshake r0 = r11.handshake     // Catch:{ all -> 0x0136 }
                if (r0 != 0) goto L_0x00fe
                kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0136 }
            L_0x00fe:
                okhttp3.CipherSuite r0 = r0.cipherSuite()     // Catch:{ all -> 0x0136 }
                java.lang.String r0 = r0.javaName()     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r0 = r3.writeUtf8(r0)     // Catch:{ all -> 0x0136 }
                r0.writeByte(r6)     // Catch:{ all -> 0x0136 }
                okhttp3.Handshake r0 = r11.handshake     // Catch:{ all -> 0x0136 }
                java.util.List r0 = r0.peerCertificates()     // Catch:{ all -> 0x0136 }
                r11.writeCertList(r3, r0)     // Catch:{ all -> 0x0136 }
                okhttp3.Handshake r0 = r11.handshake     // Catch:{ all -> 0x0136 }
                java.util.List r0 = r0.localCertificates()     // Catch:{ all -> 0x0136 }
                r11.writeCertList(r3, r0)     // Catch:{ all -> 0x0136 }
                okhttp3.Handshake r0 = r11.handshake     // Catch:{ all -> 0x0136 }
                okhttp3.TlsVersion r0 = r0.tlsVersion()     // Catch:{ all -> 0x0136 }
                java.lang.String r0 = r0.javaName()     // Catch:{ all -> 0x0136 }
                okio.BufferedSink r0 = r3.writeUtf8(r0)     // Catch:{ all -> 0x0136 }
                r0.writeByte(r6)     // Catch:{ all -> 0x0136 }
            L_0x0130:
