        ...
        try {
            ...
            if (cacheResponse != null) {
                if (networkResponse == null || networkResponse.code() != 304) {
                    ...
                    Response response2 = newBuilder.headers(companion.combine(cacheResponse.headers(), networkResponse.headers())).sentRequestAtMillis(networkResponse.sentRequestAtMillis()).receivedResponseAtMillis(networkResponse.receivedResponseAtMillis()).cacheResponse(companion.stripBody(cacheResponse)).networkResponse(companion.stripBody(networkResponse)).build();
            ...
            Response response3 = newBuilder2.cacheResponse(companion2.stripBody(cacheResponse)).networkResponse(companion2.stripBody(networkResponse)).build();
            if (this.cache != null) {
