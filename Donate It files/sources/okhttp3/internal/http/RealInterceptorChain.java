...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    public RealInterceptorChain(RealCall call2, List<? extends Interceptor> interceptors2, int index2, Exchange exchange2, Request request2, int connectTimeoutMillis2, int readTimeoutMillis2, int writeTimeoutMillis2) {
    ...
    public static /* synthetic */ RealInterceptorChain copy$okhttp$default(RealInterceptorChain realInterceptorChain, int i, Exchange exchange2, Request request2, int i2, int i3, int i4, int i5, Object obj) {
        ...
        if ((i5 & 2) != 0) {
            exchange3 = realInterceptorChain.exchange;
        } else {
            exchange3 = exchange2;
        }
        if ((i5 & 4) != 0) {
            request3 = realInterceptorChain.request;
        } else {
            request3 = request2;
        }
        if ((i5 & 8) != 0) {
        ...
        return realInterceptorChain.copy$okhttp(i, exchange3, request3, i6, i7, i8);
    }

    public final RealInterceptorChain copy$okhttp(int index2, Exchange exchange2, Request request2, int connectTimeoutMillis2, int readTimeoutMillis2, int writeTimeoutMillis2) {
        Request request3 = request2;
        Intrinsics.checkParameterIsNotNull(request2, "request");
        return new RealInterceptorChain(this.call, this.interceptors, index2, exchange2, request2, connectTimeoutMillis2, readTimeoutMillis2, writeTimeoutMillis2);
    }
    ...
    public Interceptor.Chain withConnectTimeout(int timeout, TimeUnit unit) {
        ...
        return copy$okhttp$default(this, 0, (Exchange) null, (Request) null, Util.checkDuration("connectTimeout", (long) timeout, unit), 0, 0, 55, (Object) null);
    }
    ...
    public Interceptor.Chain withReadTimeout(int timeout, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return copy$okhttp$default(this, 0, (Exchange) null, (Request) null, 0, Util.checkDuration("readTimeout", (long) timeout, unit), 0, 47, (Object) null);
    }
    ...
    public Interceptor.Chain withWriteTimeout(int timeout, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return copy$okhttp$default(this, 0, (Exchange) null, (Request) null, 0, 0, Util.checkDuration("writeTimeout", (long) timeout, unit), 31, (Object) null);
    }
    ...
    public Response proceed(Request request2) throws IOException {
        ...
        if (this.index < this.interceptors.size()) {
            ...
            RealInterceptorChain next = copy$okhttp$default(this, this.index + 1, (Exchange) null, request2, 0, 0, 0, 58, (Object) null);
