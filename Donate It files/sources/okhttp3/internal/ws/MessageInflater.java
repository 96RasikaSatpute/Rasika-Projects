...
public final class MessageInflater implements Closeable {
    ...
    public MessageInflater(boolean noContextTakeover2) {
    ...
    public final void inflate(Buffer buffer) throws IOException {
        ...
        if (!(this.deflatedBytes.size() == 0)) {
        ...
        } else if (buffer.size() == 1 && buffer.getByte(0) == ((byte) 0)) {
            buffer.skip(1);
        } else {
            ...
            do {
                this.inflaterSource.read(buffer, LongCompanionObject.MAX_VALUE);
