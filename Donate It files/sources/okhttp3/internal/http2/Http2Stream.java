...
public final class Http2Stream {
                        ...
                        try {
                            ...
                            if (!this.closed) {
                                if (this.readBuffer.size() > j2) {
                                    ...
                                    readBytesDelivered = buffer2.read(buffer, Math.min(j, buffer2.size()));
    ...
    public final class FramingSink implements Sink {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:22:0x0065, code lost:
            if (r12.this$0.getSink$okhttp().finished != false) goto L_0x00ce;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:41:0x00b3, code lost:
            if (r12.sendBuffer.size() <= 0) goto L_0x00ce;
         */
        ...
        public void close() throws java.io.IOException {
            ...
            L_0x0040:
                ...
                monitor-enter(r1)
                r2 = 0
                boolean r3 = r12.closed     // Catch:{ all -> 0x00ea }
                if (r3 == 0) goto L_0x004c
                monitor-exit(r1)
                return
            L_0x004c:
                okhttp3.internal.http2.Http2Stream r3 = okhttp3.internal.http2.Http2Stream.this     // Catch:{ all -> 0x00ea }
                okhttp3.internal.http2.ErrorCode r3 = r3.getErrorCode$okhttp()     // Catch:{ all -> 0x00ea }
                r4 = 0
                r5 = 1
            ...
            L_0x0059:
                r0 = r3
                kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00ea }
                monitor-exit(r1)
                okhttp3.internal.http2.Http2Stream r1 = okhttp3.internal.http2.Http2Stream.this
            ...
            L_0x00ce:
                ...
                monitor-enter(r1)
                r2 = 0
                r12.closed = r5     // Catch:{ all -> 0x00e7 }
                kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00e7 }
                monitor-exit(r1)
                okhttp3.internal.http2.Http2Stream r1 = okhttp3.internal.http2.Http2Stream.this
