...
public final class Http2ExchangeCodec implements ExchangeCodec {
    ...
    public Http2ExchangeCodec(OkHttpClient client, RealConnection connection2, RealInterceptorChain chain2, Http2Connection http2Connection2) {
        Protocol protocol2;
        ...
        public final List<Header> http2HeadersList(Request request) {
            ...
            while (i < size) {
                ...
                if (name != null) {
                    ...
                    if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(name2) || (Intrinsics.areEqual((Object) name2, (Object) Http2ExchangeCodec.TE) && Intrinsics.areEqual((Object) headers.value(i), (Object) "trailers"))) {
