...
public final class Dispatcher {
    ...
    private final RealCall.AsyncCall findExistingCallWithHost(String host) {
        ...
        while (it.hasNext()) {
            ...
            if (Intrinsics.areEqual((Object) existingCall.getHost(), (Object) host)) {
                return existingCall;
            }
        }
        ...
        while (it2.hasNext()) {
            ...
            if (Intrinsics.areEqual((Object) existingCall2.getHost(), (Object) host)) {
    ...
    public final ExecutorService m1049deprecated_executorService() {
        return executorService();
    }
}
